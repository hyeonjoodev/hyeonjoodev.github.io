...
const _routes = [
  {
    name: "about",
    path: "/about",
    component: () => import("./_nuxt/index-1J3kQ34e.js")
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-_QuagTUP.js")
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import("./_nuxt/default-iXalNdrp.js")),
  "error-layout": defineAsyncComponent(() => import("./_nuxt/errorLayout-C6hEhs2b.js"))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-DuTtVgfY.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-28Q5K_1e.js"));
